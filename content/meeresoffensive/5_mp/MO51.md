...
ctas:
  ...
  - short: false
    ...
    full: false
    text: |-
      Informiere dich und andere über alternative Konzepte, lokale Küstengemeinschaften direkt in Entscheidungsprozesse einzubeziehen, zum Beispiel (hier)[https://fair-oceans.info/].
  - short: false
    part: false
    full: true
    text: |-
      Arbeite bei einer entwicklungspolitischen Organsiation, zum Beispiel (dieser)[https://www.forumue.de/ueber-uns/].
animation:
number_of_frames:
---
